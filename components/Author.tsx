  ...
  return (
    <div className="flex justify-between w-full mb-12">
      ...
      <div className="flex justify-center items-center">
        ...
        >
          <span aria-label="Link to LinkedIn page">
        ...
        <Link legacyBehavior={true} href="https://twitter.com/ryancarmody_dev">
          <span className="hidden sm:block" aria-label="Link to Twitter page">
            <div className="w-12 h-12 flex items-center justify-center">
              <svg
        ...
        <Link legacyBehavior={true} href="https://github.com/rjc23">
          <span aria-label="Link to GitHub page">
            <div className="w-12 h-12 flex items-center justify-center">
              <svg
